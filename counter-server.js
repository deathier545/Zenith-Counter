...
<title>MoonHub Time Counter</title>
<style>
:root{
...
function getTimeElapsed() {
  ...
  // If current time is before 3:52 PM today, we're still in the same day
  // so we should show 0 time elapsed
  if (now < startTime) {
...
<body>
  <main class="card">
    <div class="hdr">
      <div class="logo">🌙</div>
      <div class="h1">MoonHub · Time Counter</div>
    </div>
    ...
    <div class="help">Time elapsed since 3:52 PM today</div>
  </main>
...
app.listen(PORT, () => console.log("Time counter server listening on port", PORT));
